...
require "SWWS_Config"
require "SWWS_Data"
local myStrings = require('radio/SWWS_LocaleBugFix')

SWWS_Core = {}

local oldGetRadioText = getRadioText

function getRadioText(str, ...)
	local ret = oldGetRadioText(str, ...)
	return ret == str and myStrings[str] or ret
end
