...
MSTBaseGameCharacterDetails.DoTraits = function()
	...
	local nimble = TraitFactory.addTrait("Nimble", getText("UI_trait_nimble"), 2, getText("UI_trait_nimbledesc"), false);
    nimble:addXPBoost(Perks.Nimble, 1)

	-- Mixed traits	
	local marathonrunner = TraitFactory.addTrait("MarathonRunner", getText("UI_trait_marathonrunner"), 4, getText("UI_trait_marathonrunnerdesc"), false);
	marathonrunner:addXPBoost(Perks.Fitness, 1)
	marathonrunner:addXPBoost(Perks.Sprinting, 1)
		
	local strongnimble = TraitFactory.addTrait("StrongNimble", getText("UI_trait_strongnimble"), 5, getText("UI_trait_strongnimbledesc"), false);
	...
	local amelectrician = TraitFactory.addTrait("AMElectrician", getText("UI_trait_amelectrician"), 2, getText("UI_trait_amelectriciandesc"), false);
	...
	-- Combat traits
	local durabile = TraitFactory.addTrait("Durabile", getText("UI_trait_durabile"), 2, getText("UI_trait_durabiledesc"), false);
