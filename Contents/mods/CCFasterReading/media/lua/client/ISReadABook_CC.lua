...
local modSettings = CCFastRead_global.SETTINGS
local ReadSpeedFactorSetting = {2,5,10,25,50,100};

function ISReadABook:new(character, item, time)
    local o = {}
	local ReadSpeedFactor = tonumber(ReadSpeedFactorSetting[tonumber(modSettings.options.dropdown1)]);
    setmetatable(o, self)
    self.__index = self
