...
LootMaps.Init.monmouthcountymap = function(mapUI)
    ...
    mapAPI:setBoundsInSquares(11484, 8099, 12359, 8699)
    overlayPNG(mapUI, 12300, 8100, 0.401, "badge", "media/textures/worldMap/MonmouthCountyBadge.png")
    overlayPNG(mapUI, 11481, 8099, 0.401, "backdrop", "media/textures/worldMap/Backdropfiller.png")
    overlayPNG(mapUI, 11481, 8472, 0.401, "legend", "media/textures/worldMap/Legend.png")
    MapUtils.overlayPaper(mapUI)
--  overlayPNG(mapUI, 36*300, 21*300+190, 0.666, "lootMapPNG", "media/ui/LootableMaps/monmouthcountymap.png", 0.5)
