...
VehicleZoneDistribution.trailerpark.vehicles["Base.92amgeneralM998Burnt"] = {index = -1, spawnChance = 0};
...
VehicleZoneDistribution.bad.vehicles["Base.92amgeneralM998Burnt"] = {index = -1, spawnChance = 0};

VehicleZoneDistribution.junkyard.vehicles["Base.92amgeneralM998"] = {index = -1, spawnChance = 0};
VehicleZoneDistribution.junkyard.vehicles["Base.92amgeneralM998Burnt"] = {index = -1, spawnChance = 0};
...
VehicleZoneDistribution.trafficjams.vehicles["Base.92amgeneralM998Burnt"] = {index = -1, spawnChance = 0};
